            ...
            {notifOpen && (
              ...
              >
                ...
                <div className="px-4 py-2.5" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                  <Link href="/portal/dashboard" className="text-[11px] text-[#5E6AD2] hover:text-[#8b97ff] transition-colors" onClick={() => setNotifOpen(false)}>
                    View all in Inbox →
                  </Link>
                </div>
              </div>
