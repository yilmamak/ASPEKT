...
const SUB_FEATURES = [
  { id: '3.1', label: 'Runs where you run' },
  { id: '3.2', label: 'Works where you work' },
  { id: '3.3', label: 'Multi-channel reporting' },
  { id: '3.4', label: 'Monitoring & alerts' },
];

const aspekts = [
  { id: 'INV', name: 'Invoice intake',  status: 'running', lastRun: '2 min ago', count: '847 today',   dot: '#4ade80', label: 'Running',  bg: 'rgba(74,222,128,0.08)',  border: 'rgba(74,222,128,0.2)'  },
  { id: 'CRM', name: 'Lead enrichment', status: 'running', lastRun: '5 min ago', count: '124 updated', dot: '#4ade80', label: 'Running',  bg: 'rgba(74,222,128,0.08)',  border: 'rgba(74,222,128,0.2)'  },
  { id: 'LGL', name: 'Contract review', status: 'flagged', lastRun: '1 hr ago',  count: '2 flagged',  dot: '#fbbf24', label: 'Flagged',  bg: 'rgba(251,191,36,0.08)', border: 'rgba(251,191,36,0.2)' },
  { id: 'HR',  name: 'HR onboarding',   status: 'idle',    lastRun: '3 hr ago',  count: '—',          dot: '#555558', label: 'Idle',    bg: 'rgba(85,85,88,0.08)',   border: 'rgba(85,85,88,0.2)'   },
];
...
export function FeatureSystem() {
  ...
  return (
    <section id="system" className="py-24 bg-[#0a0a0a]">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-4xl sm:text-5xl font-semibold text-[#f0f0f0] leading-tight tracking-tight">
              Runs where your business runs.
            </h2>
            <p className="text-lg text-[#7A7A7E] leading-relaxed">
              The ASPEKT system executes multi-step ASPEKTs autonomously and reports back through the tools your team already uses.
            </p>
          ...
          <div className="relative">
            ...
            >
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-[9.5px] text-[#555558]" style={{ fontFamily: 'Arial, sans-serif' }}>{a.id}</span>
                      </div>
              ...
              {/* Channel badges — renkli */}
              <div className="px-4 pb-4 pt-1 border-t border-[#1f1f1f] mt-1">
                <p className="text-[9.5px] text-[#7A7A7E] uppercase tracking-wider mb-2.5">Delivers to</p>
                <div className="flex flex-wrap gap-1.5">
                  {CHANNELS.map(ch => (
                    <span key={ch.name}
                      className="text-[11px] px-2.5 py-1 font-medium cursor-pointer transition-all duration-150 hover:brightness-125"
                      style={{
                        color: ch.color,
                        background: ch.bg,
                ...
                <p className="text-[10px] text-[#555558] mt-2">Already using something else? We integrate with what you have.</p>
              </div>
            </Window>
          </div>
